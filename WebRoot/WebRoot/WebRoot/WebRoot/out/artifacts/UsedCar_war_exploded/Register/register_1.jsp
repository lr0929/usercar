  ...
  <script type="text/javascript">
  		$(function(){
  			$(":input #user").blur(function(){
  				$.ajax({
  					url:"RegServlet?uname=" + $(":input #user").val(),
  					type:"get",
  					success:function(data){
  						$(":input #user").next().text(JSON.parse(data).username);
  					}
  				});
  			});
  		});
            ...
            <div id="login"><!-- 登录注册切换动画 -->
                ...
                <span>
                    <form action="RegServlet" method="POST">
                        ...
                        <input type="submit" value="注册" class="btn" onclick='signin()' id="btn">
                    </form>
                    	<a href="Login/login_1.jsp" >已有账号，去登录</a>
