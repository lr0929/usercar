...
<html>
  ...
  <link rel="stylesheet" href="js/main.css" type="text/css"></link>
  </head>
            ...
            <div id="login"><!-- 登录注册切换动画 -->
                ...
                <span>
                    <form action="LogServlet" method="post">
                        <p class="form">手机号：<input type="text" id="user" name="uname" placeholder="请输入手机号"></p>
                        <p class="form">密&nbsp;&nbsp;码：<input type="password" id="passwd" name="upwd" placeholder="请输入密码"></p>
                        <input type="submit" value="登录" class="btn" onclick='signin()' id="btn">
                    </form>
                    	<a href="Register/register_1.jsp" style="border:1px solid blue">没有账号，去注册</a>
                    <a href="home.jsp" style="border:cornflowerblue 1px solid; color: palegoldenrod">回到主页</a>
                </span>
            </div>
